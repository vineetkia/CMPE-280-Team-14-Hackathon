      ...
      >
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/60">Sign in to your StudyPilot account</p>
          </div>
          ...
          <p className="mt-6 text-center text-white/50 text-sm">
            ...
            <Link href="/register" className="text-white/90 hover:text-white font-medium underline underline-offset-2 transition-colors">
              Create one
            </Link>
          </p>
        </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#667eea] via-[#764ba2] to-[#667eea]">
