...
import { GraduationCap, Mail, Lock, LogIn, AlertCircle, Moon, Sun } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-semibold text-[var(--foreground)] tracking-tight">Welcome back</h1>
          <p className="text-sm text-[var(--muted-foreground)] mt-1">Sign in to your StudyPilot account</p>
        </div>
        ...
        <p className="mt-5 text-center text-[var(--muted-foreground)] text-sm">
          ...
          <Link href="/register" className="text-[var(--primary-solid)] hover:underline font-medium transition-colors">
            Create one
          </Link>
        </p>
      </motion.div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center bg-[var(--background-solid)]">
